...
1.  This is the important part – we're hosting the blog at the root of the
  ...
  [blog_dir]: ../../documentation/setup/setting-up-a-blog.md#+blog.blog_dir
...
behavior and much more.
  ...
  [exact same Markdown flavor]: ../../documentation/reference/index.md
  [post slugs]: ../../documentation/setup/setting-up-a-blog.md#+blog.post_url_format
  [draft]: ../../documentation/setup/setting-up-a-blog.md#drafts
  [This behavior can be changed]: ../../documentation/setup/setting-up-a-blog.md#+blog.draft
  [live preview server]: #
  [archive]: ../../documentation/setup/setting-up-a-blog.md#archive
  [category]: ../../documentation/setup/setting-up-a-blog.md#categories
  [Blog]: blog-support-just-landed/blog.png
  [Blog post]: blog-support-just-landed/blog.png
  [Adding an excerpt]: ../../documentation/setup/setting-up-a-blog.md#adding-an-excerpt
  [Adding authors]: ../../documentation/setup/setting-up-a-blog.md#adding-authors
  [Adding categories]: ../../documentation/setup/setting-up-a-blog.md#adding-categories
  [Adding tags]: ../../documentation/setup/setting-up-a-blog.md#adding-tags
  [Adding related links]: ../../documentation/setup/setting-up-a-blog.md#adding-related-links
  [Linking from and to posts]: ../../documentation/setup/setting-up-a-blog.md#linking-from-and-to-posts
  [Setting the reading time]: ../../documentation/setup/setting-up-a-blog.md#setting-the-reading-time
  [Setting defaults]: ../../documentation/setup/setting-up-a-blog.md#setting-defaults
  [configuration options]: ../../documentation/setup/setting-up-a-blog.md#configuration
