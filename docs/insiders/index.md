...
- [x] [Navigation subtitles]
  ...
  [Meta plugin]: ../documentation/plugins/meta.md
  [Blog plugin: related links]: ../documentation/setup/setting-up-a-blog.md#adding-related-links
  [Blog plugin: custom index pages]: ../documentation/setup/setting-up-a-blog.md#custom-index-pages
  [Tags plugin: additional indexes]: ../documentation/setup/setting-up-tags.md#+tags.tags_extra_files
  [Tags plugin: allow list]: ../documentation/setup/setting-up-tags.md#+tags.tags_allowed
  [custom sorting]: ../documentation/setup/setting-up-tags.md#+tags.tags_compare
  [Navigation subtitles]: ../documentation/reference/index.md#setting-the-page-subtitle
...
- [x] [Blog plugin: author profiles]
  ...
  [Optimize plugin]: ../documentation/plugins/optimize.md
  [Typeset plugin]: ../documentation/plugins/typeset.md
  [Privacy plugin: external links]: ../documentation/setup/ensuring-data-privacy.md#+privacy.links
  [Privacy plugin: optimization support]: ../documentation/setup/ensuring-data-privacy.md#+privacy.assets_include
  [Navigation path]: ../documentation/setup/setting-up-navigation.md#navigation-path
  [Instant prefetching]: ../documentation/setup/setting-up-navigation.md#instant-prefetching
  [Blog plugin: advanced settings]: ../documentation/setup/setting-up-a-blog.md#advanced-settings
  [Blog plugin: author profiles]: ../documentation/setup/setting-up-a-blog.md#adding-author-profiles
...
- [x] [Tags plugin: shadow tags]
  ...
  [Social plugin: custom layouts]: ../documentation/setup/setting-up-social-cards.md#customization
  [Social plugin: background images]: ../documentation/setup/setting-up-social-cards.md#+social.cards_layout_params.background_image
  [Code range selection]: ../documentation/reference/code-blocks.md#code-selection-button
  [Code annotations: custom selectors]: ../documentation/reference/code-blocks.md#custom-selectors
  [Stay on page when switching languages]: ../documentation/setup/changing-the-language.md#stay-on-page
  [Tags plugin: nested tags]: ../documentation/plugins/tags.md#config.tags_hierarchy
  [Tags plugin: shadow tags]: ../documentation/plugins/tags.md#config.shadow

#### $ 28,000 – Lemon Drop

- [x] [Tags plugin: advanced settings]

  [Tags plugin: advanced settings]: ../documentation/setup/setting-up-tags.md#advanced-settings
...
- [x] [Document contributors]
  ...
  [Privacy plugin]: ../documentation/setup/ensuring-data-privacy.md#built-in-privacy-plugin
  [Card grids]: ../documentation/reference/grids.md
  [Tooltips]: ../documentation/reference/tooltips.md
  [Content tabs: anchor links]: ../documentation/reference/content-tabs.md#anchor-links
  [Automatic light / dark mode]: ../documentation/setup/changing-the-colors.md#automatic-light-dark-mode
  [Document contributors]: ../documentation/setup/adding-a-git-repository.md#document-contributors
...
- [x] [Navigation status]
  ...
  [Blog plugin]: ../documentation/setup/setting-up-a-blog.md
  [Chinese search support]: ../blog/posts/chinese-search-support.md
  [Annotations]: ../documentation/reference/annotations.md
  [Navigation icons]: ../documentation/reference/index.md#setting-the-page-icon
  [Navigation pruning]: ../documentation/setup/setting-up-navigation.md#navigation-pruning
  [Navigation status]: ../documentation/reference/index.md#setting-the-page-status
...
- [x] [Offline plugin]
  ...
  [Excluding content from search]: ../documentation/setup/setting-up-site-search.md#search-exclusion
  [Offline plugin]: ../documentation/setup/building-for-offline-usage.md
...
- [x] Sidebars automatically scroll to active item
  ...
  [Code annotations: strip comments]: ../documentation/reference/code-blocks.md#stripping-comments
  [Tag icons]: ../documentation/setup/setting-up-tags.md#tag-icons-and-identifiers
  [Table of contents anchor following]: ../documentation/setup/setting-up-navigation.md#anchor-following
...
- [x] [Dismissable announcement bar]
  ...
  [Cookie consent]: ../documentation/setup/ensuring-data-privacy.md#cookie-consent
  [Was this page helpful?]: ../documentation/setup/setting-up-site-analytics.md#was-this-page-helpful
  [Dismissable announcement bar]: ../documentation/setup/setting-up-the-header.md#mark-as-read
...
- [x] [Linking content tabs]
  ...
  [Boosting pages in search]: ../documentation/setup/setting-up-site-search.md#search-boosting
  [Custom admonition icons]: ../documentation/reference/admonitions.md#admonition-icons
  [Linking content tabs]: ../documentation/reference/content-tabs.md#linked-content-tabs
...
- [x] [Tags with search integration]
  ...
  [Mermaid.js integration]: ../documentation/reference/diagrams.md
  [Tags with search integration]: ../documentation/setup/setting-up-tags.md
...
- [x] [Version warning]
  ...
  [Anchor tracking]: ../documentation/setup/setting-up-navigation.md#anchor-tracking
  [Code annotations]: ../documentation/reference/code-blocks.md#adding-annotations
  [Version warning]: ../documentation/setup/setting-up-versioning.md#version-warning
...
- [x] [Remove generator notice]
  ...
  [Sticky navigation tabs]: ../documentation/setup/setting-up-navigation.md#sticky-navigation-tabs
  [Section index pages]: ../documentation/setup/setting-up-navigation.md#section-index-pages
  [Remove generator notice]: ../documentation/setup/setting-up-the-footer.md#generator-notice
...
- [x] [Search sharing]
  ...
  [Search suggestions]: ../documentation/setup/setting-up-site-search.md#search-suggestions
  [Search highlighting]: ../documentation/setup/setting-up-site-search.md#search-highlighting
  [Search sharing]: ../documentation/setup/setting-up-site-search.md#search-sharing
...
- [x] [Back-to-top button]
  ...
  [Color palette toggle]: ../documentation/setup/changing-the-colors.md#color-palette-toggle
  [Back-to-top button]: ../documentation/setup/setting-up-navigation.md#back-to-top-button
...
- [x] [Versioning]
  ...
  [Admonition inline blocks]: ../documentation/reference/admonitions.md#inline-blocks
  [Site language selection]: ../documentation/setup/changing-the-language.md#site-language-selector
  [Versioning]: ../documentation/setup/setting-up-versioning.md#versioning
...
- [x] [Header hides on scroll]
  ...
  [Navigation sections]: ../documentation/setup/setting-up-navigation.md#navigation-sections
  [Navigation expansion]: ../documentation/setup/setting-up-navigation.md#navigation-expansion
  [Hiding the sidebars]: ../documentation/setup/setting-up-navigation.md#hiding-the-sidebars
  [Table of contents in navigation]: ../documentation/setup/setting-up-navigation.md#navigation-integration
  [Header hides on scroll]: ../documentation/setup/setting-up-the-header.md#automatic-hiding
