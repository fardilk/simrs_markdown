...
For a list of all settings, please consult the [plugin documentation].
  ...
  [plugin documentation]: ../../documentation/plugins/privacy.md
...
!!! question "Why can't Material for MkDocs bundle all assets by design?"
  ...
  [example]: #example
  [built-in optimize plugin]: ../../documentation/plugins/optimize.md
...
??? example "Expand to inspect example"
  ...
  [built-in privacy plugin]: ../../documentation/plugins/privacy.md
