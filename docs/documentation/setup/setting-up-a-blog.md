...
__Check out our [blog], which is created with the new [built-in blog plugin]!__
  ...
  [archive]: ../../documentation/plugins/blog.md#archive
  [category]: ../../documentation/plugins/blog.md#categories
  [post slugs]: ../../documentation/plugins/blog.md#config.post_url_format
  [pagination]: ../../documentation/plugins/blog.md#pagination
  [blog]: ../../blog/index.md
...
We'll add more settings here, as we discover new use cases.
  ...
  [plugin documentation]: ../../documentation/plugins/blog.md

  [Insiders]: ../../insiders/index.md
  [built-in blog plugin]: ../../documentation/plugins/blog.md
  [built-in plugins]: ../../insiders/getting-started.md#built-in-plugins
  [docs_dir]: https://www.mkdocs.org/user-guide/configuration/#docs_dir
  [start writing your first post]: #writing-your-first-post

  [config.archive_pagination]: ../../documentation/plugins/blog.md#config.archive_pagination
  [config.archive_pagination_per_page]: ../../documentation/plugins/blog.md#config.archive_pagination_per_page
  [config.categories_sort_by]: ../../documentation/plugins/blog.md#config.categories_sort_by
  [config.categories_sort_reverse]: ../../documentation/plugins/blog.md#config.categories_sort_reverse
  [config.categories_pagination]: ../../documentation/plugins/blog.md#config.categories_pagination
  [config.categories_pagination_per_page]: ../../documentation/plugins/blog.md#config.categories_pagination_per_page
  [config.authors_profiles_pagination]: ../../documentation/plugins/blog.md#config.authors_profiles_pagination
  [config.authors_profiles_pagination_per_page]: ../../documentation/plugins/blog.md#config.authors_profiles_pagination_per_page
...
For further information, see the [documentation].
  ...
  [categories]: ../../documentation/plugins/blog.md#categories
...
1.  More info about [blog_dir](../../documentation/plugins/blog.md#config.blog_dir)
...
automatically generated for you.
  ...
  [draft]: ../../documentation/plugins/blog.md#drafts
  [This behavior can be changed]: ../../documentation/plugins/blog.md#config.draft
  [live preview server]: #
...
reading a post before deciding to jump in.
  ...
  [excerpt separator]: ../../documentation/plugins/blog.md#config.post_excerpt_separator
...
```
  ...
  [authors]: ../../documentation/plugins/blog.md#authors
  [authors_file]: ../../documentation/plugins/blog.md#config.authors_file
...
the content of the page.
  ...
  [authors_profiles]: ../../documentation/plugins/blog.md#config.authors_profiles
...
the list.
  ...
  [categories_allowed]: ../../documentation/plugins/blog.md#config.categories_allowed
...
linked with their titles.
  ...
  [built-in tags plugin]: ../../documentation/plugins/tags.md
...
case for the [`nav`][nav] setting.
  ...
  [subtitle]: ../../documentation/reference/index.md#setting-the-page-subtitle
...
This will disable automatic reading time computation.
  ...
  [enabled]: ../../documentation/plugins/blog.md#config.post_readtime
...
`.meta.yml` and then add specific properties or overrides for each post.
  ...
  [built-in meta plugin]: ../../documentation/plugins/meta.md
...
All post excerpts belonging to the category are automatically appended.
  ...
  [page description]: ../../documentation/reference/index.md#setting-the-page-description
  [categories_url_format]: ../../documentation/plugins/blog.md#config.categories_url_format
  [categories_slugify]: ../../documentation/plugins/blog.md#config.categories_slugify
