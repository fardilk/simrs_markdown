...
Social card of our [formatting] reference
  ...
  [default layouts]: ../../documentation/plugins/social.md#layouts
...
For a list of all settings, please consult the [plugin documentation].
  ...
  [plugin documentation]: ../../documentation/plugins/social.md
...
!!! info "The [`site_url`][site_url] setting must be set"
  ...
  [dependencies for image processing]: ../../documentation/plugins/requirements/image-processing.md
...
- [`cards_layout_options.title`](../../documentation/plugins/social.md#option.title)
- [`cards_layout_options.description`](../../documentation/plugins/social.md#option.description)

  [Changing the title]: ../../documentation/reference/index.md#setting-the-page-title
  [Changing the description]: ../../documentation/reference/index.md#setting-the-page-description
...
[`cards_layout`](../../documentation/plugins/social.md#meta.social.cards_layout) key, exactly as
in `mkdocs.yml`:
...
Simply define [`cards_layout_options`](../../documentation/plugins/social.md#meta.social.cards_layout_options):
...
The following sections explain how to create custom layouts.
  ...
  [built-in social plugin]: ../../documentation/plugins/social.md
...
useful for alignment and composition.
  ...
  [debug]: ../../documentation/plugins/social.md#debugging
