...
=== "7.x"
  ...
  [Tabbed]: ../documentation/setup/extensions/python-markdown-extensions.md#tabbed
...
=== "5.x"
  ...
  [tabs]: ../documentation/setup/setting-up-navigation.md#navigation-tabs
...
- Slight facelifting of some UI elements (admonitions, tables, ...)
  ...
  [CSS variables]: ../documentation/setup/changing-the-colors.md#custom-colors
