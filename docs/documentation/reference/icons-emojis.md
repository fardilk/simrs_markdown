...
can be added] and used in `mkdocs.yml`, documents and templates.
  ...
  [icon search]: #search
  [custom icons can be added]: ../../documentation/setup/changing-the-logo-and-icons.md#additional-icons
...
- [Emoji with custom icons]
  ...
  [Emoji]: ../../documentation/setup/extensions/python-markdown-extensions.md#emoji
  [Emoji with custom icons]: ../../documentation/setup/extensions/python-markdown-extensions.md#+pymdownx.emoji.options.custom_icons
...
Markdown and HTML formatting.
  ...
  [built-in typeset plugin]: ../../documentation/plugins/typeset.md
