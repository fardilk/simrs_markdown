...
!!! warning "Requirements when using [custom color schemes]"
  ...
  [custom color schemes]: ../../documentation/setup/changing-the-colors.md#custom-color-schemes
  [EMR Picture]: ../../documentation/setup/changing-the-colors.md#custom-color-schemes
